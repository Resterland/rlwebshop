...
use Aimeos\MW\Translation\None;
use Aimeos\MW\View\Helper\Access\All;
use Aimeos\MW\View\Helper\Response\Standard;
...
class TestHelperJsonadm
{
    ...
    private static function createContext($site)
    {
        ...
        $ctx->setEditor('rlwebshop:admin/jsonadm');
    ...
    protected static function createView(Iface $config)
    {
        ...
        $config = new Protect($config, array('admin/jsonadm'));
        ...
        $helper = new Standard($view, new Response());
